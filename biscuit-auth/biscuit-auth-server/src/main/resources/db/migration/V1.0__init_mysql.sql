...
(
    ...
    `status`                    varchar(20)                      NOT NULL DEFAULT '0' COMMENT '登陆用户状态',
...
CREATE TABLE `t_menu`
(
    `id`             varchar(36) COLLATE utf8mb4_bin NOT NULL COMMENT '菜单id',
    ...
    `parent_id`      varchar(36) COLLATE utf8mb4_bin NOT NULL DEFAULT 0 COMMENT '父菜单ID',
    `path`           varchar(200)                             DEFAULT '' COMMENT '路由地址',
    `icon`           varchar(100)                             DEFAULT '#' COMMENT '菜单图标',
    `component`      varchar(255)                             DEFAULT NULL COMMENT '组件路径',
    `component_name` varchar(255)                             DEFAULT NULL COMMENT '组件名',
    `status`         varchar(20)                     NOT NULL DEFAULT 0 COMMENT '菜单状态',
...
(
    ...
    `menu_id`     varchar(36) COLLATE utf8mb4_bin COMMENT '菜单id',
    `create_time` datetime                        NOT NULL COMMENT '创建时间',
    `creator`     varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '创建人',
    `updater`     varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '更新人',
    `update_time` datetime                        DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    `tenant_id`   varchar(36) COLLATE utf8mb4_bin NOT NULL COMMENT '租户编码',
    `url_method`  varchar(36) COLLATE utf8mb4_bin COMMENT '请求方法',
    `url_path`    varchar(256) COLLATE utf8mb4_bin COMMENT '请求地址',
    `match_type`  varchar(20) COLLATE utf8mb4_bin COMMENT '匹配类型,ANT ,REGX',
    `auth_type`   varchar(20)                     NOT NULL COMMENT '资源鉴权类型,无需鉴权、登录鉴权、完整鉴权',
    `description` varchar(512) COLLATE utf8mb4_bin COMMENT '资源描述',
    PRIMARY KEY (`id`)
...
(
    ...
    `update_time` datetime                        DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    `role_id`     varchar(36) COLLATE utf8mb4_bin NOT NULL COMMENT '角色id',
    `menu_id`     varchar(36) COLLATE utf8mb4_bin NOT NULL COMMENT '菜单id',
    `tenant_id`   varchar(36) COLLATE utf8mb4_bin NOT NULL COMMENT '租户编码',
    PRIMARY KEY (`id`) USING BTREE
